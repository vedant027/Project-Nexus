            ...
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                     <ul class="nav__list">
                        ...
                        <li class="nav__item">
                            <a href="php/logout.php" class="nav__link">Log Out</a>
                        </li>
                     </ul>
        ...
        <main class="main">
            ...
            <section class="popular section" id="popular">
                ...
                <div class="popular__container container grid">
                    ...
                    <article class="popular__card">
                        <img src="assets/img/popular-spring-rolls.png" alt="popular image" class="popular__img">
        ...
        <footer class="footer">
            ...
            <div class="footer__info container">
                ...
                <span class="footer__copy">
                    &#169; Copyright The Sushi. All rights reserved
                </span>
            </div>
        </footer>
